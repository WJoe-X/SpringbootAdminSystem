...
INSERT INTO `menu` (`menu_id`, `menu_name`, `menu_type`, `menu_url`, `menu_code`, `parent_id`, `parent_ids`, `child_num`, `listorder`, `created_at`, `updated_at`) VALUES ('16b6a67592f94442ab270be030b1bb15', '图片列表', 'auth', '/console/picture/index', 'picture:list', 'b3496a2ddaf445f881f865a094e71820', NULL, '2', '0', '2018-05-16 11:08:59', '2018-05-16 11:08:59');
